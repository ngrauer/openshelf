import { BookOpen, Inbox, LogOut, MessageCircle, ShoppingBag, Tag } from "lucide-react";
...
export function DashboardLayout({ view, onViewChange, children, onOpenChat }) {
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      {/* Floating chatbot launcher — widget itself lands in C10. */}
      <Button
        onClick={onOpenChat}
        size="icon"
